# Generated by Powerlevel10k configuration wizard on 2023-04-24 at 22:31 CEST.
...
# angled separators, blurred heads, slanted tails, 1 line, sparse, many icons, fluent,
...
() {
 ...
 #   taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#1793d1
  # Custom icon.
